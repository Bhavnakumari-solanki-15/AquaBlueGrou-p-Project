    ...
    <div className="min-h-screen bg-gradient-to-br from-[#f3ecf7] to-[#e9d8fd] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <h2 className="text-3xl font-bold text-[#2d215b]">Create your account</h2>
        </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-start">
              <input
                ...
                type="checkbox"
                required
                className="h-4 w-4 text-[#6a4da8] focus:ring-[#6a4da8] border-gray-300 rounded mt-1"
              />
              <label htmlFor="terms" className="ml-2 block text-sm text-gray-700">
                I agree to the{' '}
                <Link to="/terms-and-conditions" className="font-medium text-[#6a4da8] hover:text-[#5a3d98]">
                  Terms and Conditions
                </Link>{' '}
                and{' '}
                <Link to="/privacy-policy" className="font-medium text-[#6a4da8] hover:text-[#5a3d98]">
                  Privacy Policy
                </Link>
              </label>
            </div>
            ...
            <div className="text-center">
              <p className="text-sm text-gray-600">
                ...
                <Link to="/login" className="font-medium text-[#6a4da8] hover:text-[#5a3d98]">
                  Sign in
                </Link>
              </p>
            </div>
