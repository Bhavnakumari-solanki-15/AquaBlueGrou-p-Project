...
const About: React.FC = () => {
  ...
  const testimonials = [
    {
      quote: "Aqua Blue Group's service and innovation have brought a new height to aquaculture in the north-east. Many are inspired by their management team.",
      name: "Saidul Islam",
      role: "Farmer and Social Activites",
      avatar: "https://randomuser.me/api/portraits/men/32.jpg",
      bgColor: "bg-blue-100 dark:bg-blue-800",
    },
    {
      quote: "Aqua Group brings new technologies and innovation to aquaculture.",
      name: "Mr.Ibrahim Khalil Ullah",
      role: "Farmer & Fish Trader",
      avatar: "https://randomuser.me/api/portraits/men/33.jpg",
      bgColor: "bg-purple-100 dark:bg-purple-800",
    },
    {
      quote: "Best fish feed, medicine, and on-field service for farmers all over Assam.",
      name: "Mr. Aftabur Rahman",
      role: "ASM, ABIS EXPORTS(I) PVT.LTD",
      avatar: "https://randomuser.me/api/portraits/men/34.jpg",
      bgColor: "bg-green-100 dark:bg-green-800",
    },
    {
      quote: "Aqua Blue Group always provides great service to employees and farmers alike.",
      name: "Sariful Islam",
      role: "Farmer & Fresh fish Trader",
      avatar: "https://randomuser.me/api/portraits/men/35.jpg",
      bgColor: "bg-orange-100 dark:bg-orange-800",
    },
  ];

  // Team data (moved from Team.tsx)
  const team = [
    {
      name: 'Rajaqul Islam',
    ...
    {
      name: 'Avina Sultana',
      role: 'Senior Manager, Operations and CRM',
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-700 dark:text-gray-300 max-w-3xl mx-auto">
              We offer 24×7 consultancy, high-quality fish seeds and feeds,
              aqua medicines, and laboratory services for all aquaculture needs.
            </p>
          </motion.div>
        </div>
      </div>
      ...
      <div className="font-serif">
          ...
          >
            {testimonials.map((t, idx) => (
              <SwiperSlide key={idx} className="flex h-full">
                <div className={`${t.bgColor} rounded-2xl shadow-lg p-8 pt-12 flex flex-col items-center text-center border border-gray-100 dark:border-gray-700 transition-all duration-300 hover:shadow-2xl h-[340px] w-full justify-between`}>
                  <img src={t.avatar} alt={t.name} className="w-20 h-20 rounded-full object-cover border-4 border-white dark:border-gray-900 -mt-12 mb-6 shadow-md" />
        ...
        <section className="py-20 px-4 flex flex-col items-center">
          ...
          <div className="w-full max-w-5xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 px-4 sm:px-8">
            {team.map((member) => (
              <div key={member.name} className="relative bg-white dark:bg-[#3c3a4c] rounded-xl shadow-lg overflow-hidden transform hover:scale-105 transition-transform duration-300 ease-in-out">
                <div className="relative w-full h-[24rem] rounded-t-xl overflow-hidden rounded-b-none">
                   <img src={member.img} alt={member.name} className="w-full h-full object-cover" />
                </div>
                 {/* Container for Name, Role, and LinkedIn Icon with dark background and rounded corners */}
                <div className="absolute bottom-0 left-0 right-0 bg-[#32313BB3] rounded-b-xl p-4 flex items-center justify-between">
